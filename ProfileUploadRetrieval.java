...
public class ProfileUploadRetrieval extends AssignmentEndpoint {
    ...
    public void initAssignment() {
        ...
        try {
            Files.writeString(secretDirectory.toPath().resolve("path-traversal-secret.jpg"), "You found it submit the SHA-512 hash of your username as answe1r");
        } catch (IOException e) {
...
//            var id = request.getParameter("id");
      ...
      if (!normalizedPath.startsWith(new File(BASE_DIRECTORY).getCanonicalPath())) {
